sap.ui.define([
	...
	return BaseObject.extend("com.mycompany.northwind.Fiori_Northwind.model.GroupSortState", {
		 ...
		 * @alias com.mycompany.northwind.Fiori_Northwind.model.GroupSortState
		 */
		...
		/**
		 * Sorts by ProductName, or by UnitPrice
		 *
		...
		/**
		 * Groups by UnitPrice, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "UnitPrice") {
				...
				this._oViewModel.setProperty("/sortBy", "UnitPrice");
				...
				this._oViewModel.setProperty("/sortBy", "ProductName");
			}
