...
sap.ui.define([
		...
		"com/mycompany/northwind/Fiori_Northwind/model/grouper",
		"com/mycompany/northwind/Fiori_Northwind/model/GroupSortState"
	], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, grouper, GroupSortState) {
		"use strict";

		return BaseController.extend("com.mycompany.northwind.Fiori_Northwind.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.mycompany.northwind.Fiori_Northwind.view.ViewSettingsDialog", this);
