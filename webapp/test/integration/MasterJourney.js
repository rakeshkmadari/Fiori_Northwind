...
sap.ui.define([
	...
	opaTest("MasterList Filtering on UnitPrice less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<UnitPrice>").
			and.iSelectListItemInViewSettingsDialog("<100 <UnitPrice>").
	...
	opaTest("MasterList Filtering on UnitPrice more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <UnitPrice>").
			and.iPressOKInViewSelectionDialog();
