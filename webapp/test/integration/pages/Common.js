sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/mycompany/northwind/Fiori_Northwind/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.mycompany.northwind.Fiori_Northwind.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/mycompany/northwind/Fiori_Northwind/localService/mockserver"], function (mockserver) {
